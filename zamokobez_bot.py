...
# === GitHub ===
GITHUB_TOKEN = os.environ.get("GITHUB_TOKEN", "ваш_токен_если_не_через_env")
REPO_OWNER = os.environ.get("REPO_OWNER", "ваш_username")
REPO_NAME = os.environ.get("REPO_NAME", "ваш_repo")
